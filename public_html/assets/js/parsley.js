  ...
  ParsleyField.prototype = {
    ...
    , addConstraint: function ( constraint, doNotUpdateValidationEvents ) {
      var pureName = '';
        ...
        for ( var name in constraint ) {
          pureName = name.toLowerCase().replace(/^parsley/, '');

          if ( 'function' === typeof this.Validator.validators[ pureName ] ) {
            this.constraints[ pureName ] = {
                name: pureName
            ...
            if ( pureName === 'required' ) {
              this.isRequired = true;
            }

            this.addCustomConstraintMessage( pureName );
          }
        }
    ...
    */
    , addCustomConstraintMessage: function ( constraint ) {
      ...
      customMessage = 'parsley' + customMessage.charAt(0).toUpperCase() + customMessage.substr(1);
